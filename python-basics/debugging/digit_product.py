# You've been asked to implement a function called digit_product that takes 
# a string of digits as an argument and returns the product of all the digits in the string.
...
def digit_product(str_num):
    ...
    product = 1  # Originally intialized as '0'
